...
#Load R data
load("/lustre/projects/Research_Project-MRC164847/Luke_W/APOE_methylation/APOE_meta_analysis/New_QC/EPIC_IDATS/AD_inf/AD_inf_Bulk_PFC/4_analysis/results/APOE_2_without_Braak_EWASout.rdat")
