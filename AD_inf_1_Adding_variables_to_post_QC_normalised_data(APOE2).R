...
setwd("/lustre/projects/Research_Project-MRC164847/Luke_W/APOE_methylation/APOE_meta_analysis/New_QC/EPIC_IDATS/AD_inf/AD_inf_Bulk_PFC/3_normalised/")
...
ADD_VARS <- read_excel("AD_inf_ADD_COLUMNS.xlsx")
head(ADD_VARS)
